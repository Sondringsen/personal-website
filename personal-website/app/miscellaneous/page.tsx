...
export default function Miscellaneous() {
    ...
    const tabs: Tab[] = [
        {index: 0, label: 'Favorite Books', component: <MarkdownRenderer markdownUrl="/miscellaneous/favorite_books.md" />},
        {index: 1, label: 'Favorite Movies', component: <MarkdownRenderer markdownUrl="/miscellaneous/favorite_movies.md" />}
    ];
